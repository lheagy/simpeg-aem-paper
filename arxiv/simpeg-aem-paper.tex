...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.85\textwidth]{currents.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.95\textwidth]{magnetic_flux.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.7\textwidth]{1Dinversion.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.7\textwidth]{2Dvoxel_inversion.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[width=0.7\textwidth]{2Dparametric_inversion.png}
